...
function myFunction3()
{
	...
	btn1.innerHTML = "問題三";
	btn3.innerHTML = "      ";
	btn2.innerHTML = "是否在學習如何使用工具、設備和小器具上有困難?  例如：電視、音響、冷氣機、洗衣機、熱水爐（器）";
	btn4.innerHTML = "---------------------------------------------------------------------------";
...
function showfinalgrade() 
{
	...
	if (point>=2)
	{
		btn3.innerHTML = "情況稍微嚴重，建議尋求專業醫師的協助。請參照網站內“就醫資訊頁面”，找尋適合的醫院或診所，儘早就醫。";
	}

	if (point==1)
	{
		btn3.innerHTML = "情況並沒有到很嚴重，但建議良好的飲食睡眠與運動習慣。可以參照網站內“預防方法”頁面，裡面附有生活習慣建議。";
	}
